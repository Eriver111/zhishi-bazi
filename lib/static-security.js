...
const PUBLIC_DIRS = new Set(['css', 'js', 'images', 'fonts', 'promo_animations', 'books']);
const PUBLIC_ROOT_FILES = new Set([
  ...
  'verify.html', 'ziwei.html', 'zw-ai-chat.html', 'disclaimer.html', 'library.html', 'library-cases.html',
