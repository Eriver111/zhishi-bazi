# R01 · 实际发送给模型的完整 messages 数组（复刻 api/ai-chat.js callAI，mode=pro，history=[]）
...
出生：1984年3月6日 6时 性别：男

四柱排盘：
  年柱：甲子 [木] 天干十神：正官 地支十神：偏财 纳音：海中金 藏干：癸(偏财)
  月柱：丁卯 [火] 天干十神：偏印 地支十神：七杀 纳音：炉中火 藏干：乙(七杀)
  日柱：己亥 [土] 天干十神：日主 地支十神：正财 纳音：平地木 藏干：壬(正财)、甲(正官)
  时柱：庚午 [金] 天干十神：伤官 地支十神：偏印 纳音：路旁土 藏干：丁(偏印)、己(比肩)

日主：己(土阴) 旺衰：极弱
五行分布：金1 木5 水4 火3 土2

【排盘结构化数据】日主旺衰评定：极弱（评分 24，元气清秀）。请以此为本次解读口径，不另行编造分数或替换强弱等级。
命局格局：杀印相生格（同柱复合类） 月令五行：木
格局状态：破格
破格原因：日主极弱，难以承载格局用神
格局成立条件清单：
  ✅ 印星不被财破 —— ✓
  ❌ 官/杀不被食伤制死 —— 伤官克官，官印链断裂
  ✅ 印星有力（非燥土虚浮） —— ✓

格局解读：月干偏印 + 月支七杀——杀印相生格，月令透杀，果断刚毅有魄力。杀需制化——食神制杀出武将，印化杀出文贵。
...
喜用忌神分析：
  ...
  忌神：木、金、水
  取用方法：格局救应
  核心依据：杀印相生格条件不足，先取能扶正旺衰并兼顾格局救应的五行。
  判定证据：
    - 旺衰：综合评定身极弱（24分）。命局中克泄耗力量偏重，日主需印比扶助。
    - 格局：日主极弱，难以承载格局用神
    - 根气/透干：火：透于月柱天干，见于时柱地支
    - 生克链·杀印相生：月令卯主气乙木为七杀，并见月干丁火偏印贴近日主，形成杀印相生的通关路径。日主另有长生/禄根，结构承接较稳。
    - 生克链·财生杀印截：年支子（水）生月支卯（木），同时见月干丁（火，偏印），存在官杀生印、印再生身的通关路径；能否有效转化仍须结合旺衰、透干与受制情况。
    - 生克链·食伤制杀：时柱天干庚（食伤·金）克制月令七杀——"食神制杀，英雄独压万人"。
    - 生克链·日主根气：时柱地支午为日主禄位（强根）；时柱地支午藏己土（中气根）
    - 生克链·滴天髓：《滴天髓》己土章：「不愁木盛，不畏水狂」——己土卑湿柔韧，木克不倒水冲不散；「宜助宜帮」——己土喜丙火生、戊土帮，得助则万物茂盛。
    - 候选对比：取火（印，综合分 26.0）；未取土（比劫，26.0）、木（官杀，-26.0）、金（食伤，-26.0）、水（财，-26.0）
  五行归类理由：
    - 用神·火：格局救应：印星生身，是本局首要的调节力量；透于月柱天干，见于时柱地支
    - 喜神·土：比劫同类，用于辅助用神并维持命局流通；透于日柱天干
    - 忌神·木：官杀制身，会加重当前失衡或破坏已有制化；透于年柱天干，见于月柱地支
    - 忌神·金：食伤泄秀，会加重当前失衡或破坏已有制化；透于时柱天干
    - 忌神·水：财星耗身，会加重当前失衡或破坏已有制化；见于年柱地支、日柱地支
  生克链分析：
    - [structure] 杀印相生：月令卯主气乙木为七杀，并见月干丁火偏印贴近日主，形成杀印相生的通关路径。日主另有长生/禄根，结构承接较稳。
    - [structure] 财生杀印截：年支子（水）生月支卯（木），同时见月干丁（火，偏印），存在官杀生印、印再生身的通关路径；能否有效转化仍须结合旺衰、透干与受制情况。
    - [info] 食伤制杀：时柱天干庚（食伤·金）克制月令七杀——"食神制杀，英雄独压万人"。
    - [info] 日主根气：时柱地支午为日主禄位（强根）；时柱地支午藏己土（中气根）
    - [classic] 滴天髓：《滴天髓》己土章：「不愁木盛，不畏水狂」——己土卑湿柔韧，木克不倒水冲不散；「宜助宜帮」——己土喜丙火生、戊土帮，得助则万物茂盛。
  生克链修正：
    - [highlight_ambivalent] 水：财生官杀，同时存在官杀生印的候选通路，须结合全局判断能否通关
    - [highlight_ambivalent] 木：官杀克身但同时存在生印路径，实际作用取决于印星承接与全局旺衰
    - [downgrade_ji] 金：食伤虽泄身但能制杀护主
  用神真假评估：
    - 火：偏真用神——有根但不够深固，如小树有根，中年后运势方能支撑（根气得分2）
      根气详情：午本气根；透干month；被克：子(year)地支根被冲
    - 土：假用神——原局虚浮无根，徒有其名无其实，需行运见根方有用武之地（根气得分0）
      根气详情：午中气根；被克：甲天干直克

四柱关系事件（事实层枚举）：
  - 刑：year+month（水、木），涉月令/日支
  - 天干五合：year+day（木、土化土），涉月令/日支
  - 天干克：year+hour（金克木）
  - 六冲：year+hour（水、火）
  - 半合：month+day（卯亥合木），涉月令/日支
  - 半会：day+year（亥子会水），涉月令/日支

条件性结构风险（解释层；severity 仅存在/潜在；不是喜用忌结论，不得据此把风险元素解释成忌神）：
  - 伤官见官[潜在]：时柱庚伤官 ↔ 年柱甲正官。天干同透伤官与正官，全 pair 枚举 1 对（贴身 0 对）。缓解：正官甲被己合绊(d2，中)；伤官与正官远隔（不直接对贴）。若伤官庚（金）得根行旺或正官甲失其制化，伤官见官之势可能显化；当前正官甲被己合绊(d2，中)、全对远隔。 结构显现：时柱庚伤官:exposedUnrooted；年柱甲正官:exposedRooted
  - 关键用神/格局节点受冲[潜在]：年柱子 ↔ 时柱午（印星之根；用神同五行；用神干丁之禄）。六冲子午命中；时柱午（印星之根；用神同五行；用神干丁之禄），位距3。缓解：无。若年柱子（癸水·偏财）得运助增，对时柱午（印星之根；用神同五行；用神干丁之禄）的冲击可能加重，相关格局节点根基可能动摇。 结构显现：年柱year（癸水·偏财）:hiddenMainRoot；时柱hour（丁火·偏印）:exposedRooted
  - 财印冲[潜在]：年柱子（癸水） ↔ 时柱午（丁火）。冲对主气一财一印，位距3。缓解：无。若财方年柱子（癸水·偏财）进一步增强，财印相冲可能加重，印星根基可能进一步受扰。 结构显现：年柱子（癸水·偏财）:hiddenMainRoot；时柱午（丁火·偏印）:exposedRooted
...
宫位远近分析：
  提纲(月柱)：月柱丁卯（提纲），印星坐提纲，月令生身——得天时之助，贵人之地。
  归息(时柱)：时柱庚午（归息），晚年食伤——儿孙缘厚，晚年享乐。
  祖业(年柱)：年柱甲子（祖业），祖上官杀——家规严苛或祖上有权威传承。
  宫位解读：提纲为印生身，得月令天时之利；
...
日支（夫妻宫）专项分析：
  ...
  日主根气：无根（根气分0）
  稳定度：稳固——配偶宫根基扎实，感情稳定
  三合角色：亥参与木局（卯），日支有合局之助
  三会角色：亥属水方，为三会局成员
  藏干详析：本气壬(正财)——本气正财——配偶务实、管钱、旺财 | 中气甲(正官)——中气正官——配偶有责任感、守规矩
  综合：日支亥为正财，无根。稳固——配偶宫根基扎实，感情稳定。亥参与木局（卯），日支有合局之助
...
大运喜用忌联动分析：
  ...
  戊辰（11-2003岁）：天干土为喜神，地支土为喜神 → 综合判定：喜运
    运程：大运戊辰（11-2003），天干土比劫（喜神），地支土（喜神）。此运喜用双全，人生上升期。
  己巳（21-2013岁）：天干土为喜神，地支火为用神 → 综合判定：喜运 [大运冲日支（夫妻宫/自身根基）——十年动荡]
    运程：大运己巳（21-2013），天干土比劫（喜神），地支火（用神）。此运喜用双全，人生上升期。
  庚午（31-2023岁）：天干金为忌神，地支火为用神 → 综合判定：偏喜
    运程：大运庚午（31-2023），天干金食伤（忌神），地支火（用神）。天干为忌但地支有喜——内里有靠，低调蓄力。
  辛未（41-2033岁）：天干金为忌神，地支土为喜神 → 综合判定：偏喜 [大运未补全三合木局，所化五行在本命喜忌中为忌神；是否成化仍需结合月令、透干与受制情况判断。]
    运程：大运辛未（41-2033），天干金食伤（忌神），地支土（喜神）。天干为忌但地支有喜——内里有靠，低调蓄力。
  壬申（51-2043岁）：天干水为忌神，地支金为忌神 → 综合判定：忌运
    运程：大运壬申（51-2043），天干水财星（忌神），地支金（忌神）。此运忌神当道，宜守不宜攻。
  癸酉（61-2053岁）：天干水为忌神，地支金为忌神 → 综合判定：忌运 [大运冲提纲（月支卯）——十年根基动摇]
    运程：大运癸酉（61-2053），天干水财星（忌神），地支金（忌神）。此运忌神当道，宜守不宜攻。
  甲戌（71-2063岁）：天干木为忌神，地支土为喜神 → 综合判定：偏喜
    运程：大运甲戌（71-2063），天干木官杀（忌神），地支土（喜神）。天干为忌但地支有喜——内里有靠，低调蓄力。
  乙亥（81-2073岁）：天干木为忌神，地支水为忌神 → 综合判定：忌运
    运程：大运乙亥（81-2073），天干木官杀（忌神），地支水（忌神）。此运忌神当道，宜守不宜攻。

神煞：天乙贵人(ji-shen)、月德贵人(ji-shen)、福星贵人(ji-shen)、禄神(ji-shen)、金舆(ji-shen)、将星(ji-shen)、红鸾(ji-shen)、灾煞(ji)、亡神(ji)、勾绞(ji)、月德合(ji-shen)、流霞(ji)、白虎(ji)、天哭(ji)

四柱地支冲合刑害：
  年柱子 ←→ 月柱卯：相刑
    - 年柱地支子 刑 月柱地支卯
  年柱子 ←→ 时柱午：六冲
    - 年柱地支子 冲 时柱地支午——变动冲突分离之象

当前时间：2026年
当前大运：辛未（食神）2024-2033年 41岁
当前流年：丙午（正印）2026年
  注意：当前行食神大运，遇正印流年——需结合大运流年与原局关系综合判断吉凶。
...
天干五合：
  年柱甲 + 日柱己 → 合而不化（化土）：隔柱不化：年柱与日柱相距太远，合力微弱
...
```
【排盘事实锁】日主旺衰=「极弱（24）」，候选格局=「杀印相生格」，状态=「破格」，原因=「日主极弱，难以承载格局用神」。以上字段不另行重算；破格不得写成已成格；旺衰档位、格局状态、risk severity 均为冻结标签，禁止近义词换级。
```
