# TH07 · 实际发送给模型的完整 messages 数组（复刻 api/ai-chat.js callAI，mode=pro，history=[]）
...
出生：1967年8月5日 0时 性别：男

四柱排盘：
  年柱：丁未 [火] 天干十神：七杀 地支十神：偏印 纳音：天河水 藏干：己(偏印)、丁(七杀)、乙(偏财)
  月柱：丁未 [火] 天干十神：七杀 地支十神：偏印 纳音：天河水 藏干：己(偏印)、丁(七杀)、乙(偏财)
  日柱：辛丑 [金] 天干十神：日主 地支十神：偏印 纳音：壁上土 藏干：己(偏印)、癸(食神)、辛(比肩)
  时柱：戊子 [土] 天干十神：正印 地支十神：食神 纳音：霹雳火 藏干：癸(食神)

日主：辛(金阴) 旺衰：偏弱
五行分布：金2 木2 水3 火4 土8

【排盘结构化数据】日主旺衰评定：偏弱（评分 31，元气偏柔）。请以此为本次解读口径，不另行编造分数或替换强弱等级。
命局格局：七杀格（透干取格类） 月令五行：土
格局状态：破格
破格原因：月令受日柱冲；印星为燥土，虚浮不化杀
格局成立条件清单：
...
喜用忌神分析：
  ...
  忌神：火、木、土
  取用方法：格局救应
  核心依据：七杀格条件不足，先取能扶正旺衰并兼顾格局救应的五行。
  判定证据：
    - 旺衰：综合评定身偏弱（31分）。命局中克泄耗力量偏重，日主需印比扶助。
    - 格局：月令受日柱冲；印星为燥土，虚浮不化杀
    - 根气/透干：水：见于时柱地支
    - 生克链·日支被冲：日支丑被年柱地支未冲——根基动摇。日主坐根被冲，力量打折扣。
    - 生克链·日支被冲：日支丑被月柱地支未冲——根基动摇。日主坐根被冲，力量打折扣。
    - 生克链·日支受刑：日支丑与年柱地支未相刑——暗中不和，需注意人际关系。
    - 生克链·日支受刑：日支丑与月柱地支未相刑——暗中不和，需注意人际关系。
    - 生克链·日主根气：日柱地支丑藏辛金（余气根）；时柱地支子为日主长生之位（有气之根，靠印滋养）
    - 生克链·库冲开库：未、丑库支发生冲/刑，相关藏干受到引动。官/杀印通关、日主得库气。
    - 生克链·官/杀印通关：未库藏丁（火，七杀）受到引动，存在生印、印再生身的通关可能。
    - 生克链·日主得库气：丑库藏辛受到引动，与日主同五行，可作为根气增强的候选证据。
    - 生克链·库开代价：库支发生冲/刑时，除藏干受到引动外，也会改变土气的稳定状态。土在本命中所对应的十神及其喜忌，须与相关藏干一并权衡。
    - 生克链·滴天髓：《滴天髓》辛金章：「畏土之叠」——土多埋金，辛金珠玉之光被掩；「乐水之盈」——水淘辛金，珠玉愈发光洁，食伤泄秀为美；「热则喜母」——夏金销熔，喜湿土（辰丑）生金护金。
  五行归类理由：
    - 用神·水：格局救应：食伤泄秀，是本局首要的调节力量；见于时柱地支
    - 喜神·金：比劫同类，用于辅助用神并维持命局流通；透于日柱天干
    - 忌神·火：官杀制身，会加重当前失衡或破坏已有制化；透于年柱天干、月柱天干
    - 忌神·木：财星耗身，会加重当前失衡或破坏已有制化；原局未直接出现
    - 忌神·土：印星生身，会加重当前失衡或破坏已有制化；透于时柱天干，见于年柱地支、月柱地支、日柱地支
  生克链分析：
    - [warning] 日支被冲：日支丑被年柱地支未冲——根基动摇。日主坐根被冲，力量打折扣。
    - [warning] 日支被冲：日支丑被月柱地支未冲——根基动摇。日主坐根被冲，力量打折扣。
    - [info] 日支受刑：日支丑与年柱地支未相刑——暗中不和，需注意人际关系。
    - [info] 日支受刑：日支丑与月柱地支未相刑——暗中不和，需注意人际关系。
    - [info] 日主根气：日柱地支丑藏辛金（余气根）；时柱地支子为日主长生之位（有气之根，靠印滋养）
    - [structure] 库冲开库：未、丑库支发生冲/刑，相关藏干受到引动。官/杀印通关、日主得库气。
    - [structure] 官/杀印通关：未库藏丁（火，七杀）受到引动，存在生印、印再生身的通关可能。
    - [structure] 日主得库气：丑库藏辛受到引动，与日主同五行，可作为根气增强的候选证据。
    - [info] 库开代价：库支发生冲/刑时，除藏干受到引动外，也会改变土气的稳定状态。土在本命中所对应的十神及其喜忌，须与相关藏干一并权衡。
    - [classic] 滴天髓：《滴天髓》辛金章：「畏土之叠」——土多埋金，辛金珠玉之光被掩；「乐水之盈」——水淘辛金，珠玉愈发光洁，食伤泄秀为美；「热则喜母」——夏金销熔，喜湿土（辰丑）生金护金。
  生克链修正：
    - [downgrade_xi] 金：日支被冲，根气受损
    - [highlight_ambivalent] 火：库支受冲刑后，火（官杀）存在官杀生印、印再生身的通关可能；能否转化须看透干、旺衰及全局承接
  用神真假评估：
    - 水：偏真用神——有根但不够深固，如小树有根，中年后运势方能支撑（根气得分2）
      根气详情：丑中气根；子本气根；被克：戊天干直克
    - 金：假用神——原局虚浮无根，徒有其名无其实，需行运见根方有用武之地（根气得分-1.5）
      根气详情：丑余气根；被克：丁天干直克；丁天干直克

四柱关系事件（事实层枚举）：
  - 天干克：year+day（火克金），涉月令/日支
  - 六冲：year+day（土、土），涉月令/日支
  - 刑：year+day（土、土），涉月令/日支
  - 六害：year+hour（土、水）
  - 天干克：month+day（火克金），涉月令/日支
  - 六冲：month+day（土、土），涉月令/日支
  - 刑：month+day（土、土），涉月令/日支
  - 六害：month+hour（土、水），涉月令/日支
  - 六合：day+hour（土、水化土），涉月令/日支
  - 半会：hour+day（子丑会水），涉月令/日支

条件性结构风险（解释层；severity 仅存在/潜在；不是喜用忌结论，不得据此把风险元素解释成忌神）：
  - 关键用神/格局节点受冲[存在]：年柱未（印星之根） ↔ 日柱丑（印星之根）。六冲未丑命中年柱未（印星之根）；日柱丑（印星之根），位距2、涉日支。缓解：无。若日柱丑（己土·偏印）得运助增，对年柱未（印星之根）的冲击可能加重；若年柱未（己土·偏印）得运助增，对日柱丑（印星之根）的冲击可能加重，相关格局节点根基可能动摇。 结构显现：年柱year（己土·偏印）:hiddenMainRoot；日柱day（己土·偏印）:hiddenMainRoot
  - 关键用神/格局节点受冲[存在]：月柱未（印星之根） ↔ 日柱丑（印星之根）。六冲未丑命中月柱未（印星之根）；日柱丑（印星之根），位距1、涉月令、涉日支。缓解：无。若日柱丑（己土·偏印）得运助增，对月柱未（印星之根）的冲击可能加重；若月柱未（己土·偏印）得运助增，对日柱丑（印星之根）的冲击可能加重，相关格局节点根基可能动摇。 结构显现：月柱month（己土·偏印）:hiddenMainRoot；日柱day（己土·偏印）:hiddenMainRoot

四柱相邻生克关系：
  年柱 → 月柱：天干—，地支—
  月柱 → 日柱：天干克，地支冲
    - 月柱天干丁(火) 克 日柱天干辛(金)
    - 月柱地支未 与 日柱地支丑 六冲——主变动冲突
  日柱 → 时柱：天干被生，地支克
    - 时柱天干戊(土) 生 日柱天干辛(金)
    - 日柱地支丑(土) 克 时柱地支子(水)

宫位远近分析：
  提纲(月柱)：月柱丁未（提纲），官杀当令克身——压力重重，但若有制化反成权威。
  归息(时柱)：时柱戊子（归息），晚岁得印星庇护——老来有靠，福泽绵长。
  祖业(年柱)：年柱丁未（祖业），祖上官杀——家规严苛或祖上有权威传承。
  宫位解读：提纲官杀制身但归息印星解围——先难后易之命；

日支（夫妻宫）专项分析：
  日支丑（土），偏印——配偶思维独特、理工气质
  日主根气：藏干余气根（根气分0.5）
  日支互动：
    - 冲·年柱：丑未冲——配偶宫被冲，感情多变动，自身根基不稳
    - 刑·年柱：丑未刑——配偶宫有刑伤，需防矛盾升级
    - 冲·月柱：丑未冲——配偶宫被冲，感情多变动，自身根基不稳
    - 刑·月柱：丑未刑——配偶宫有刑伤，需防矛盾升级
    - 合·时柱：丑子合——配偶宫被合，感情易受外界牵绊
  稳定度：动荡——配偶宫不宁，婚姻是人生重大课题
  三合角色：丑为金局之一，待大运/流年补全
  三会角色：丑属水方，为三会局成员
  藏干详析：本气己(偏印)——本气偏印——配偶思维独特、理工气质 | 中气癸(食神)——中气食神——配偶温和会享受、有口福 | 余气辛(比肩)——余气比肩——配偶独立平等、像战友
  综合：日支丑为偏印，藏干余气根。动荡——配偶宫不宁，婚姻是人生重大课题。丑未冲——配偶宫被冲，感情多变动，自身根基不稳；丑未刑——配偶宫有刑伤，需防矛盾升级；丑未冲——配偶宫被冲，感情多变动，自身根基不稳；丑未刑——配偶宫有刑伤，需防矛盾升级；丑子合——配偶宫被合，感情易受外界牵绊；丑为金局之一，待大运/流年补全

流年丙午三方互动分析：
  判词：偏凶（凶兆分0，吉兆分0）
  ⚠ [medium] 流年合日主：流年丙与日主辛相合，表示相关人事议题容易被牵动；合而能否化、最终利弊均须结合月令与喜忌，不直接定吉凶。
  总结：流年天干为忌神火，行事多阻。
...
大运喜用忌联动分析：
  ...
  丙午（10-1985岁）：天干火为忌神，地支火为忌神 → 综合判定：忌运
    运程：大运丙午（10-1985），天干火官杀（忌神），地支火（忌神）。此运忌神当道，宜守不宜攻。
  乙巳（20-1995岁）：天干木为忌神，地支火为忌神 → 综合判定：忌运
    运程：大运乙巳（20-1995），天干木财星（忌神），地支火（忌神）。此运忌神当道，宜守不宜攻。
  甲辰（30-2005岁）：天干木为忌神，地支土为忌神 → 综合判定：忌运
    运程：大运甲辰（30-2005），天干木财星（忌神），地支土（忌神）。此运忌神当道，宜守不宜攻。
  癸卯（40-2015岁）：天干水为用神，地支木为忌神 → 综合判定：偏喜
    运程：大运癸卯（40-2015），天干水食伤（用神），地支木（忌神）。天干有喜但地支为忌——表面风光，暗流涌动。
  壬寅（50-2025岁）：天干水为用神，地支木为忌神 → 综合判定：偏喜
    运程：大运壬寅（50-2025），天干水食伤（用神），地支木（忌神）。天干有喜但地支为忌——表面风光，暗流涌动。
  辛丑（60-2035岁）：天干金为喜神，地支土为忌神 → 综合判定：偏喜 [大运冲提纲（月支未）——十年根基动摇]
    运程：大运辛丑（60-2035），天干金比劫（喜神），地支土（忌神）。天干有喜但地支为忌——表面风光，暗流涌动。
  庚子（70-2045岁）：天干金为喜神，地支水为用神 → 综合判定：喜运
    运程：大运庚子（70-2045），天干金比劫（喜神），地支水（用神）。此运喜用双全，人生上升期。
  己亥（80-2055岁）：天干土为忌神，地支水为用神 → 综合判定：偏喜
    运程：大运己亥（80-2055），天干土印星（忌神），地支水（用神）。天干为忌但地支有喜——内里有靠，低调蓄力。

神煞：文昌贵人(ji-shen)、福星贵人(ji-shen)、学堂(ji-shen)、桃花(zhong)、华盖(zhong)、元辰(ji)、阴差阳错(ji)

四柱地支冲合刑害：
  年柱未 ←→ 日柱丑：六冲、相刑
    - 年柱地支未 冲 日柱地支丑——变动冲突分离之象
    - 年柱地支未 刑 日柱地支丑
  年柱未 ←→ 时柱子：六害
    - 年柱地支未 害 时柱地支子——暗中不利貌合神离
  月柱未 ←→ 日柱丑：六冲、相刑
    - 月柱地支未 冲 日柱地支丑——变动冲突分离之象
    - 月柱地支未 刑 日柱地支丑
  月柱未 ←→ 时柱子：六害
    - 月柱地支未 害 时柱地支子——暗中不利貌合神离
  日柱丑 ←→ 时柱子：六合
    - 日柱地支丑 合 时柱地支子——和谐合作吸引之象

当前时间：2026年
当前大运：辛丑（比肩）2026-2035年 60岁
当前流年：丙午（正官）2026年
  注意：当前行比肩大运，遇正官流年——需结合大运流年与原局关系综合判断吉凶。
...
```
【排盘事实锁】日主旺衰=「偏弱（31）」，候选格局=「七杀格」，状态=「破格」，原因=「月令受日柱冲；印星为燥土，虚浮不化杀」。以上字段不另行重算；破格不得写成已成格；旺衰档位、格局状态、risk severity 均为冻结标签，禁止近义词换级。
```
