# S07 · 实际发送给模型的完整 messages 数组（复刻 api/ai-chat.js callAI，mode=pro，history=[]）
...
出生：1860年9月13日 9时 性别：男

四柱排盘：
  年柱：庚申 [金] 天干十神：比肩 地支十神：比肩 纳音：石榴木 藏干：庚(比肩)、壬(食神)、戊(偏印)
  月柱：乙酉 [木] 天干十神：正财 地支十神：劫财 纳音：泉中水 藏干：辛(劫财)
  日柱：庚申 [金] 天干十神：日主 地支十神：比肩 纳音：石榴木 藏干：庚(比肩)、壬(食神)、戊(偏印)
  时柱：乙酉 [木] 天干十神：正财 地支十神：劫财 纳音：泉中水 藏干：辛(劫财)

日主：庚(金阳) 旺衰：极强
五行分布：金11 木2 水2 火0 土2

【排盘结构化数据】日主旺衰评定：极强（评分 100，元气充沛）。请以此为本次解读口径，不另行编造分数或替换强弱等级。
命局格局：羊刃格（月令特别格类） 月令五行：金
格局状态：破格
破格原因：羊刃无制
格局成立条件清单：
  ✅ 日主有承载格局之力 —— 日主极强（100分），可承载格局
  ❌ 官杀制刃 —— 羊刃无制，刚暴自伤

格局解读：日主得帝旺之位气势极强。"羊刃驾杀，威震边疆。"——《滴天髓》
...
喜用忌神分析：
  ...
  判定证据：
    - 旺衰：综合评定身极强（100分）。命局中帮扶力量较强，日主底气充足。
    - 调候：秋金当令，金气过旺，需火锻炼方能成器。"金无火炼，顽金不器。"
    - 格局：羊刃无制
    - 根气/透干：火：原局未直接出现
    - 生克链·日主根气：年柱地支申为日主禄位（强根）；年柱地支申藏庚金（本气强根）；月柱地支酉藏辛金（本气强根）；日柱地支申为日主禄位（强根）；日柱地支申藏庚金（本气强根）；时柱地支酉藏辛金（本气强根）
    - 生克链·滴天髓：《滴天髓》庚金章：「得水而清」——水洗庚金，锋芒更利，食伤泄秀为贵；「输于乙妹」——庚遇乙木合，刚金被柔木牵绊，锐气内敛。
    - 候选对比：取火（官杀，综合分 67.6）；未取水（食伤，54.0）、木（财，50.0）、土（印，-50.0）、金（比劫，-50.0）
  五行归类理由：
    - 用神·火：扶抑为主·调候辅助：官杀制身，是本局首要的调节力量；原局未直接出现
    - 喜神·水：食伤泄秀，用于辅助用神并维持命局流通；原局未直接出现
    - 喜神·木：财星耗身，用于辅助用神并维持命局流通；透于月柱天干、时柱天干
    - 忌神·土：印星生身，会加重当前失衡或破坏已有制化；原局未直接出现
    - 忌神·金：比劫同类，会加重当前失衡或破坏已有制化；透于年柱天干、日柱天干，见于年柱地支、月柱地支、日柱地支、时柱地支
  生克链分析：
    - [info] 日主根气：年柱地支申为日主禄位（强根）；年柱地支申藏庚金（本气强根）；月柱地支酉藏辛金（本气强根）；日柱地支申为日主禄位（强根）；日柱地支申藏庚金（本气强根）；时柱地支酉藏辛金（本气强根）
    - [classic] 滴天髓：《滴天髓》庚金章：「得水而清」——水洗庚金，锋芒更利，食伤泄秀为贵；「输于乙妹」——庚遇乙木合，刚金被柔木牵绊，锐气内敛。
  用神真假评估：
    - 火：假用神——原局虚浮无根，徒有其名无其实，需行运见根方有用武之地（根气得分0）
    - 水：偏真用神——有根但不够深固，如小树有根，中年后运势方能支撑（根气得分2）
      根气详情：申中气根；申中气根
    - 木：弱用神——根基浅薄，如浮萍水面，需大运流年补根方显其用（根气得分1）
      根气详情：透干month/hour；被克：庚天干直克

四柱关系事件（事实层枚举）：
  - 天干五合：year+month（金、木化金），涉月令/日支
  - 天干五合：year+hour（金、木化金）
  - 天干五合：month+day（木、金化金），涉月令/日支
  - 天干五合：day+hour（金、木化金），涉月令/日支
  - 半会：year+month（申酉会金），涉月令/日支
...
宫位远近分析：
  提纲(月柱)：月柱乙酉（提纲），财星当令耗身——求财心切，但需身强方能担财。
  归息(时柱)：时柱乙酉（归息），晚岁财星——老来财运，但须身强。
  祖业(年柱)：年柱庚申（祖业），祖业一般，需自身奋斗。
...
日支（夫妻宫）专项分析：
  ...
  日主根气：禄位（临官）（根气分3）
  稳定度：稳固——配偶宫根基扎实，感情稳定
  三合角色：申为水局之一，待大运/流年补全
  三会角色：申属金方，为三会局成员
  藏干详析：本气庚(比肩)——本气比肩——配偶独立平等、像战友 | 中气壬(食神)——中气食神——配偶温和会享受、有口福 | 余气戊(偏印)——余气偏印——配偶思维独特、理工气质
  综合：日支申为比肩，禄位（临官）。稳固——配偶宫根基扎实，感情稳定。申为水局之一，待大运/流年补全
...
大运喜用忌联动分析：
  一生8步大运中，喜运7步，忌运1步。整体运程偏吉，中晚年可期。
  丙戌（9-1878岁）：天干火为用神，地支土为忌神 → 综合判定：偏喜
    运程：大运丙戌（9-1878），天干火官杀（用神），地支土（忌神）。天干有喜但地支为忌——表面风光，暗流涌动。
  丁亥（19-1888岁）：天干火为用神，地支水为喜神 → 综合判定：喜运
    运程：大运丁亥（19-1888），天干火官杀（用神），地支水（喜神）。此运喜用双全，人生上升期。
  戊子（29-1898岁）：天干土为忌神，地支水为喜神 → 综合判定：偏喜
    运程：大运戊子（29-1898），天干土印星（忌神），地支水（喜神）。天干为忌但地支有喜——内里有靠，低调蓄力。
  己丑（39-1908岁）：天干土为忌神，地支土为忌神 → 综合判定：忌运
    运程：大运己丑（39-1908），天干土印星（忌神），地支土（忌神）。此运忌神当道，宜守不宜攻。
  庚寅（49-1918岁）：天干金为忌神，地支木为喜神 → 综合判定：偏喜 [大运冲日支（夫妻宫/自身根基）——十年动荡]
    运程：大运庚寅（49-1918），天干金比劫（忌神），地支木（喜神）。天干为忌但地支有喜——内里有靠，低调蓄力。
  辛卯（59-1928岁）：天干金为忌神，地支木为喜神 → 综合判定：偏喜 [大运冲提纲（月支酉）——十年根基动摇]
    运程：大运辛卯（59-1928），天干金比劫（忌神），地支木（喜神）。天干为忌但地支有喜——内里有靠，低调蓄力。
  壬辰（69-1938岁）：天干水为喜神，地支土为忌神 → 综合判定：偏喜
    运程：大运壬辰（69-1938），天干水食伤（喜神），地支土（忌神）。天干有喜但地支为忌——表面风光，暗流涌动。
  癸巳（79-1948岁）：天干水为喜神，地支火为用神 → 综合判定：喜运
    运程：大运癸巳（79-1948），天干水食伤（喜神），地支火（用神）。此运喜用双全，人生上升期。

神煞：太极贵人(ji-shen)、月德贵人(ji-shen)、福星贵人(ji-shen)、禄神(ji-shen)、桃花(zhong)、羊刃(ji)、血刃(ji)、月德合(ji-shen)、披麻(ji)、戟锋(ji)

当前时间：2026年
当前大运：丙戌（七杀）1869-1878年 9岁
当前流年：丙午（七杀）2026年
  注意：当前行七杀大运，遇七杀流年——需结合大运流年与原局关系综合判断吉凶。
...
天干五合：
  年柱庚 + 月柱乙 → 争合不化（化金）：庚被乙争合——情不专一，化气不成
  年柱庚 + 时柱乙 → 争合不化（化金）：乙被庚争合——情不专一，化气不成
  月柱乙 + 日柱庚 → 争合不化（化金）：庚被乙争合——情不专一，化气不成
  日柱庚 + 时柱乙 → 争合不化（化金）：庚被乙争合——情不专一，化气不成
...
```
【排盘事实锁】日主旺衰=「极强（100）」，候选格局=「羊刃格」，状态=「破格」，原因=「羊刃无制」。以上字段不另行重算；破格不得写成已成格；旺衰档位、格局状态、risk severity 均为冻结标签，禁止近义词换级。
```
