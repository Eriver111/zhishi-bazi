# #61 · 实际发送给模型的完整 messages 数组（复刻 api/ai-chat.js callAI，mode=pro，history=[]）
...
出生：2009年8月29日 4时 性别：男

四柱排盘：
  年柱：己丑 [土] 天干十神：伤官 地支十神：伤官 纳音：霹雳火 藏干：己(伤官)、癸(正官)、辛(正财)
  月柱：壬申 [水] 天干十神：七杀 地支十神：偏财 纳音：剑锋金 藏干：庚(偏财)、壬(七杀)、戊(食神)
  日柱：丙午 [火] 天干十神：日主 地支十神：劫财 纳音：天河水 藏干：丁(劫财)、己(伤官)
  时柱：壬辰 [水] 天干十神：七杀 地支十神：食神 纳音：长流水 藏干：戊(食神)、乙(正印)、癸(正官)

日主：丙(火阳) 旺衰：偏弱
五行分布：金4 木1 水5 火3 土7

【排盘结构化数据】日主旺衰评定：偏弱（评分 39，元气偏柔）。请以此为本次解读口径，不另行编造分数或替换强弱等级。
命局格局：财生杀格（同柱复合类） 月令五行：金
格局状态：成格
格局机制：财生杀
格局解读：月干七杀 + 月支偏财——财生杀格，月令透财，慷慨大方，商业嗅觉敏锐，适合投资经营。
...
喜用忌神分析：
  ...
  忌神：土、金、水
  取用方法：扶抑为主
  核心依据：日主偏弱（39分），以扶抑平衡为主确定用神。
  判定证据：
    - 旺衰：综合评定身偏弱（39分）。命局中克泄耗力量偏重，日主需印比扶助。
    - 格局：月柱壬申：七杀(壬) + 偏财(申)
    - 根气/透干：木：原局未直接出现
    - 生克链·财党杀：月支申（金）生月干壬（水，七杀）→ 财星生助官杀，官杀直克日主，无印星通关。「财党杀，因财致祸。」
    - 生克链·日支被害：日支午被年柱地支丑穿害——暗中破损，根气不纯。
    - 生克链·日主根气：日柱地支午藏丁火（本气强根）
    - 生克链·滴天髓：《滴天髓》丙火章：「土众成慈」——土多泄火过甚，丙火烈性转温和，但泄身太过需制土；「水猖显节」——水旺克火反显丙火之节操，水火既济为贵。
    - 候选对比：取木（印，综合分 16.3）；未取火（比劫，11.0）、水（官杀，-5.0）、金（财，-7.0）、土（食伤，-11.0）
  五行归类理由：
    - 用神·木：扶抑为主：印星生身，是本局首要的调节力量；原局未直接出现
    - 喜神·火：比劫同类，用于辅助用神并维持命局流通；透于日柱天干，见于日柱地支
    - 忌神·土：食伤泄秀，会加重当前失衡或破坏已有制化；透于年柱天干，见于年柱地支、时柱地支
    - 忌神·金：财星耗身，会加重当前失衡或破坏已有制化；见于月柱地支
    - 忌神·水：官杀制身，会加重当前失衡或破坏已有制化；透于月柱天干、时柱天干
  生克链分析：
    - [warning] 财党杀：月支申（金）生月干壬（水，七杀）→ 财星生助官杀，官杀直克日主，无印星通关。「财党杀，因财致祸。」
    - [warning] 日支被害：日支午被年柱地支丑穿害——暗中破损，根气不纯。
    - [info] 日主根气：日柱地支午藏丁火（本气强根）
    - [classic] 滴天髓：《滴天髓》丙火章：「土众成慈」——土多泄火过甚，丙火烈性转温和，但泄身太过需制土；「水猖显节」——水旺克火反显丙火之节操，水火既济为贵。
  生克链修正：
    - [upgrade_ji] 金：财星党杀攻身，无印截断
    - [downgrade_xi] 火：日支被害，根气暗损
  用神真假评估：
    - 木：弱用神——根基浅薄，如浮萍水面，需大运流年补根方显其用（根气得分1）
      根气详情：辰中气根
    - 火：假用神——原局虚浮无根，徒有其名无其实，需行运见根方有用武之地（根气得分0）
      根气详情：午本气根；被克：壬天干直克；壬天干直克

四柱关系事件（事实层枚举）：
  - 六害：year+day（土、火），涉月令/日支
...
宫位远近分析：
  提纲(月柱)：月柱壬申（提纲），官杀当令克身——压力重重，但若有制化反成权威。
  归息(时柱)：时柱壬辰（归息），晚年仍有压力——需防健康，宜早作安排。
  祖业(年柱)：年柱己丑（祖业），祖业一般，需自身奋斗。
  宫位解读：提纲官杀攻身无印化解——一生压力随身；

日支（夫妻宫）专项分析：
  日支午（火），劫财——配偶行动力强但易争执
  日主根气：帝旺（根气分3）
  日支互动：
    - 害·年柱：午丑害——暗中不利，配偶间有隐情或小人
  稳定度：稳固——配偶宫根基扎实，感情稳定
  三合角色：午为火局之一，待大运/流年补全
  三会角色：午属火方，为三会局成员
  藏干详析：本气丁(劫财)——本气劫财——配偶行动力强但易争执 | 中气己(伤官)——中气伤官——配偶聪明有才但嘴不饶人
  综合：日支午为劫财，帝旺。稳固——配偶宫根基扎实，感情稳定。午丑害——暗中不利，配偶间有隐情或小人；午为火局之一，待大运/流年补全

流年丙午三方互动分析：
  判词：偏吉（凶兆分0，吉兆分0）
  ⚠ [medium] 伏吟：流年丙午与日柱完全相同，属于日柱伏吟，既有议题容易重复或加深。
...
大运喜用忌联动分析：
  ...
  辛未（8-2025岁）：天干金为忌神，地支土为忌神 → 综合判定：忌运
    运程：大运辛未（8-2025），天干金财星（忌神），地支土（忌神）。此运忌神当道，宜守不宜攻。
  庚午（18-2035岁）：天干金为忌神，地支火为喜神 → 综合判定：偏喜
    运程：大运庚午（18-2035），天干金财星（忌神），地支火（喜神）。天干为忌但地支有喜——内里有靠，低调蓄力。
  己巳（28-2045岁）：天干土为忌神，地支火为喜神 → 综合判定：偏喜
    运程：大运己巳（28-2045），天干土食伤（忌神），地支火（喜神）。天干为忌但地支有喜——内里有靠，低调蓄力。
  戊辰（38-2055岁）：天干土为忌神，地支土为忌神 → 综合判定：忌运
    运程：大运戊辰（38-2055），天干土食伤（忌神），地支土（忌神）。此运忌神当道，宜守不宜攻。
  丁卯（48-2065岁）：天干火为喜神，地支木为用神 → 综合判定：喜运
    运程：大运丁卯（48-2065），天干火比劫（喜神），地支木（用神）。此运喜用双全，人生上升期。
  丙寅（58-2075岁）：天干火为喜神，地支木为用神 → 综合判定：喜运 [大运冲提纲（月支申）——十年根基动摇]
    运程：大运丙寅（58-2075），天干火比劫（喜神），地支木（用神）。此运喜用双全，人生上升期。
  乙丑（68-2085岁）：天干木为用神，地支土为忌神 → 综合判定：偏喜
    运程：大运乙丑（68-2085），天干木印星（用神），地支土（忌神）。天干有喜但地支为忌——表面风光，暗流涌动。
  甲子（78-2095岁）：天干木为用神，地支水为忌神 → 综合判定：偏喜 [大运冲日支（夫妻宫/自身根基）——十年动荡；大运子补全三合水局，所化五行在本命喜忌中为忌神；是否成化仍需结合月令、透干与受制情况判断。]
    运程：大运甲子（78-2095），天干木印星（用神），地支水（忌神）。天干有喜但地支为忌——表面风光，暗流涌动。

神煞：文昌贵人(ji-shen)、太极贵人(ji-shen)、月德贵人(ji-shen)、福星贵人(ji-shen)、金舆(ji-shen)、国印贵人(ji-shen)、桃花(zhong)、华盖(zhong)、天喜(ji-shen)、羊刃(ji)、亡神(ji)、元辰(ji)、勾绞(ji)、孤鸾煞(ji)、天虚(ji)、戟锋(ji)、指背(ji)

四柱地支冲合刑害：
  年柱丑 ←→ 日柱午：六害
    - 年柱地支丑 害 日柱地支午——暗中不利貌合神离

当前时间：2026年
当前大运：庚午（偏财）2026-2035年 18岁
当前流年：丙午（比肩）2026年
  注意：当前行偏财大运，遇比肩流年——需结合大运流年与原局关系综合判断吉凶。
...
```
【排盘事实锁】日主旺衰=「偏弱（39）」，候选格局=「财生杀格」，状态=「成格」。以上字段不另行重算；破格不得写成已成格；旺衰档位、格局状态、risk severity 均为冻结标签，禁止近义词换级。
```
