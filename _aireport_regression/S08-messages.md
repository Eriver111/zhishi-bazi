...
出生：1917年5月9日 6时 性别：男

四柱排盘：
  年柱：丁巳 [火] 天干十神：七杀 地支十神：正官 纳音：沙中土 藏干：丙(正官)、庚(劫财)、戊(正印)
  月柱：乙巳 [木] 天干十神：偏财 地支十神：正官 纳音：覆灯火 藏干：丙(正官)、庚(劫财)、戊(正印)
  日柱：辛亥 [金] 天干十神：日主 地支十神：伤官 纳音：钗钏金 藏干：壬(伤官)、甲(正财)
  时柱：甲午 [木] 天干十神：正财 地支十神：七杀 纳音：砂中金 藏干：丁(七杀)、己(偏印)

日主：辛(金阴) 旺衰：极弱
五行分布：金3 木3 水2 火8 土3

【排盘结构化数据】日主旺衰评定：极弱（评分 1，元气清秀）。请以此为本次解读口径，不另行编造分数或替换强弱等级。

⚠从格判定：假从势格（弃命从势）
  解读：日主极弱，克泄耗成势，不能自立，不得不从。喜克泄耗顺势而行，忌印比生扶破格。
  喜：火、木、水 忌：土、金
命局格局：假从势格（透干取格类） 月令五行：火
格局状态：成格
格局成立条件清单：
  ✅ 从格成立 —— 弃命从势，日主弱极顺势而从。

格局解读：日主极弱，克泄耗成势，不能自立，不得不从。喜克泄耗顺势而行，忌印比生扶破格。
...
喜用忌神分析：
  ...
  核心依据：弃命从势，取顺势之五行为用。
  判定证据：
    - 旺衰：综合评定身极弱（1分）。命局中克泄耗力量偏重，日主需印比扶助。
    - 格局：弃命从势（原局正官格，既成从格，以从格论）
    - 根气/透干：火：透于年柱天干，见于年柱地支、月柱地支、时柱地支
  五行归类理由：
    - 用神·火：从格顺势：官杀制身，是本局首要的调节力量；透于年柱天干，见于年柱地支、月柱地支、时柱地支
    - 喜神·木：财星耗身，用于辅助用神并维持命局流通；透于月柱天干、时柱天干
    - 喜神·水：食伤泄秀，用于辅助用神并维持命局流通；见于日柱地支
    - 忌神·土：印星生身，会加重当前失衡或破坏已有制化；原局未直接出现
    - 忌神·金：比劫同类，会加重当前失衡或破坏已有制化；透于日柱天干
  用神真假评估：
    - 火：真用神——根深蒂固有力，如大树扎根，用神得力者一生层次高（根气得分5）
      根气详情：巳本气根；巳本气根；午本气根；透干year；被克：亥(day)地支根被冲；亥(day)地支根被冲
    - 木：偏真用神——有根但不够深固，如小树有根，中年后运势方能支撑（根气得分3）
      根气详情：亥中气根；透干month/hour
    - 水：假用神——原局虚浮无根，徒有其名无其实，需行运见根方有用武之地（根气得分0）
      根气详情：亥本气根；被克：巳(year)地支根被冲；巳(month)地支根被冲

四柱关系事件（事实层枚举）：
  - 天干克：year+day（火克金），涉月令/日支
  - 六冲：year+day（火、水），涉月令/日支
  - 天干克：month+day（金克木），涉月令/日支
  - 六冲：month+day（火、水），涉月令/日支
  - 半会：year+hour（巳午会火）

条件性结构风险（解释层；severity 仅存在/潜在；不是喜用忌结论，不得据此把风险元素解释成忌神）：
  - 杀重无制[存在]：年柱丁。七杀透干1处；证据 3 项（e1当令、e2本气强根、e3多现）。缓解：无。若七杀丁再得根增强而制化不足，杀重无制之势可能加重；出现印化杀或食伤制杀则风险可能解除。 结构显现：年柱丁七杀:exposedRooted
  - 关键用神/格局节点受冲[存在]：年柱巳（用神同五行；透干七杀坐支之根） ↔ 日柱亥。六冲巳亥命中年柱巳（用神同五行；透干七杀坐支之根），位距2、涉日支。缓解：无。若日柱亥（壬水·伤官）得运助增，对年柱巳（用神同五行；透干七杀坐支之根）的冲击可能加重，相关格局节点根基可能动摇。 结构显现：年柱year（丙火·正官）:hiddenMainRoot；日柱day（壬水·伤官）:hiddenMainRoot
  - 关键用神/格局节点受冲[存在]：月柱巳（用神同五行；透干七杀坐支之根） ↔ 日柱亥。六冲巳亥命中月柱巳（用神同五行；透干七杀坐支之根），位距1、涉月令、涉日支。缓解：无。若日柱亥（壬水·伤官）得运助增，对月柱巳（用神同五行；透干七杀坐支之根）的冲击可能加重，相关格局节点根基可能动摇。 结构显现：月柱month（丙火·正官）:hiddenMainRoot；日柱day（壬水·伤官）:hiddenMainRoot
...
四柱相邻生克关系：
  ...
  月柱 → 日柱：天干被克，地支冲
    - 日柱天干辛(金) 克 月柱天干乙(木)
    - 月柱地支巳 与 日柱地支亥 六冲——主变动冲突
  日柱 → 时柱：天干克，地支克
    - 日柱天干辛(金) 克 时柱天干甲(木)
    - 日柱地支亥(水) 克 时柱地支午(火)

宫位远近分析：
  提纲(月柱)：月柱乙巳（提纲），财星当令耗身——求财心切，但需身强方能担财。
  归息(时柱)：时柱甲午（归息），晚岁财星——老来财运，但须身强。
  祖业(年柱)：年柱丁巳（祖业），祖上官杀——家规严苛或祖上有权威传承。
  宫位解读：各宫位分布均衡，无特殊宫位偏颇。

日支（夫妻宫）专项分析：
  日支亥（水），伤官——配偶聪明有才但嘴不饶人
  日主根气：无根（根气分0）
  日支互动：
    - 冲·年柱：亥巳冲——配偶宫被冲，感情多变动，自身根基不稳
    - 冲·月柱：亥巳冲——配偶宫被冲，感情多变动，自身根基不稳
  稳定度：偏动——感情起伏较大，需双方经营
  三合角色：亥为木局之一，待大运/流年补全
  三会角色：亥属水方，为三会局成员
  藏干详析：本气壬(伤官)——本气伤官——配偶聪明有才但嘴不饶人 | 中气甲(正财)——中气正财——配偶务实、管钱、旺财
  综合：日支亥为伤官，无根。偏动——感情起伏较大，需双方经营。亥巳冲——配偶宫被冲，感情多变动，自身根基不稳；亥巳冲——配偶宫被冲，感情多变动，自身根基不稳；亥为木局之一，待大运/流年补全
...
大运喜用忌联动分析：
  ...
  甲辰（1-1927岁）：天干木为喜神，地支土为忌神 → 综合判定：偏喜
    运程：大运甲辰（1-1927），天干木财星（喜神），地支土（忌神）。天干有喜但地支为忌——表面风光，暗流涌动。
  癸卯（11-1937岁）：天干水为喜神，地支木为喜神 → 综合判定：喜运
    运程：大运癸卯（11-1937），天干水食伤（喜神），地支木（喜神）。此运喜用双全，人生上升期。
  壬寅（21-1947岁）：天干水为喜神，地支木为喜神 → 综合判定：喜运
    运程：大运壬寅（21-1947），天干水食伤（喜神），地支木（喜神）。此运喜用双全，人生上升期。
  辛丑（31-1957岁）：天干金为忌神，地支土为忌神 → 综合判定：忌运
    运程：大运辛丑（31-1957），天干金比劫（忌神），地支土（忌神）。此运忌神当道，宜守不宜攻。
  庚子（41-1967岁）：天干金为忌神，地支水为喜神 → 综合判定：偏喜
    运程：大运庚子（41-1967），天干金比劫（忌神），地支水（喜神）。天干为忌但地支有喜——内里有靠，低调蓄力。
  己亥（51-1977岁）：天干土为忌神，地支水为喜神 → 综合判定：偏喜 [大运冲提纲（月支巳）——十年根基动摇]
    运程：大运己亥（51-1977），天干土印星（忌神），地支水（喜神）。天干为忌但地支有喜——内里有靠，低调蓄力。
  戊戌（61-1987岁）：天干土为忌神，地支土为忌神 → 综合判定：忌运
    运程：大运戊戌（61-1987），天干土印星（忌神），地支土（忌神）。此运忌神当道，宜守不宜攻。
  丁酉（71-1997岁）：天干火为用神，地支金为忌神 → 综合判定：偏喜
    运程：大运丁酉（71-1997），天干火官杀（用神），地支金（忌神）。天干有喜但地支为忌——表面风光，暗流涌动。

神煞：天乙贵人(ji-shen)、天德贵人(ji-shen)、福星贵人(ji-shen)、金舆(ji-shen)、国印贵人(ji-shen)、驿马(zhong)、桃花(zhong)、丧门(ji)、孤鸾煞(ji)、月德合(ji-shen)

四柱地支冲合刑害：
  年柱巳 ←→ 日柱亥：六冲
    - 年柱地支巳 冲 日柱地支亥——变动冲突分离之象
  月柱巳 ←→ 日柱亥：六冲
    - 月柱地支巳 冲 日柱地支亥——变动冲突分离之象

当前时间：2026年
当前大运：甲辰（正财）1918-1927年 1岁
当前流年：丙午（正官）2026年
  注意：当前行正财大运，遇正官流年——需结合大运流年与原局关系综合判断吉凶。
...
```
【排盘事实锁】日主旺衰=「极弱（1）」，候选格局=「假从势格」，状态=「成格」。以上字段不另行重算；破格不得写成已成格；旺衰档位、格局状态、risk severity 均为冻结标签，禁止近义词换级。
```
