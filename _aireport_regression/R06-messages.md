# R06 · 实际发送给模型的完整 messages 数组（复刻 api/ai-chat.js callAI，mode=pro，history=[]）
...
出生：1951年10月2日 3时 性别：男

四柱排盘：
  年柱：辛卯 [金] 天干十神：七杀 地支十神：比肩 纳音：松柏木 藏干：乙(比肩)
  月柱：丁酉 [火] 天干十神：食神 地支十神：七杀 纳音：山下火 藏干：辛(七杀)
  日柱：乙亥 [木] 天干十神：日主 地支十神：正印 纳音：山头火 藏干：壬(正印)、甲(劫财)
  时柱：己卯 [土] 天干十神：偏财 地支十神：比肩 纳音：城墙土 藏干：乙(比肩)

日主：乙(木阴) 旺衰：偏弱
五行分布：金4 木6 水2 火1 土1

【排盘结构化数据】日主旺衰评定：偏弱（评分 37，元气偏柔）。请以此为本次解读口径，不另行编造分数或替换强弱等级。
命局格局：食神制杀格（同柱复合类） 月令五行：金
格局状态：破格
破格原因：月令受年柱冲；月令受时柱冲；食神虚透，制杀无力
格局成立条件清单：
  ❌ 制神有效制杀 —— 食神虚透，制杀无力

格局解读：月干食神 + 月支七杀——食神制杀格，月令透杀，果断刚毅有魄力。杀需制化——食神制杀出武将，印化杀出文贵。
...
喜用忌神分析：
  ...
  忌神：土、金、火
  取用方法：格局救应
  核心依据：食神制杀格条件不足，先取能扶正旺衰并兼顾格局救应的五行。
  判定证据：
    - 旺衰：综合评定身偏弱（37分）。命局中克泄耗力量偏重，日主需印比扶助。
    - 格局：月令受年柱冲；月令受时柱冲；食神虚透，制杀无力
    - 根气/透干：水：见于日柱地支
    - 生克链·杀印相生：月令酉主气辛金为七杀，并见日支亥中藏壬水正印贴近日主，形成杀印相生的通关路径。日主另有长生/禄根，结构承接较稳。
    - 生克链·食伤制杀：月柱天干丁（食伤·火）克制月令七杀——"食神制杀，英雄独压万人"。
    - 生克链·日主根气：年柱地支卯为日主禄位（强根）；年柱地支卯藏乙木（本气强根）；日柱地支亥藏甲木（中气根）；时柱地支卯为日主禄位（强根）；时柱地支卯藏乙木（本气强根）
    - 生克链·滴天髓：《滴天髓》乙木章：「跨凤乘猴」——乙木在申酉绝地，无甲则藤无所附，宜见火制金。
    - 候选对比：取水（印，综合分 19.0）；未取木（比劫，13.0）、火（食伤，-9.0）、土（财，-13.0）、金（官杀，-13.0）
  五行归类理由：
    - 用神·水：格局救应：印星生身，是本局首要的调节力量；见于日柱地支
    - 喜神·木：比劫同类，用于辅助用神并维持命局流通；透于日柱天干，见于年柱地支、时柱地支
    - 忌神·土：财星耗身，会加重当前失衡或破坏已有制化；透于时柱天干
    - 忌神·金：官杀制身，会加重当前失衡或破坏已有制化；透于年柱天干，见于月柱地支
    - 忌神·火：食伤泄秀，会加重当前失衡或破坏已有制化；透于月柱天干
  生克链分析：
    - [structure] 杀印相生：月令酉主气辛金为七杀，并见日支亥中藏壬水正印贴近日主，形成杀印相生的通关路径。日主另有长生/禄根，结构承接较稳。
    - [info] 食伤制杀：月柱天干丁（食伤·火）克制月令七杀——"食神制杀，英雄独压万人"。
    - [info] 日主根气：年柱地支卯为日主禄位（强根）；年柱地支卯藏乙木（本气强根）；日柱地支亥藏甲木（中气根）；时柱地支卯为日主禄位（强根）；时柱地支卯藏乙木（本气强根）
    - [classic] 滴天髓：《滴天髓》乙木章：「跨凤乘猴」——乙木在申酉绝地，无甲则藤无所附，宜见火制金。
  生克链修正：
    - [downgrade_ji] 火：食伤虽泄身但能制杀护主
  用神真假评估：
    - 水：弱用神——根基浅薄，如浮萍水面，需大运流年补根方显其用（根气得分1）
      根气详情：亥本气根；被克：己天干直克
    - 木：偏真用神——有根但不够深固，如小树有根，中年后运势方能支撑（根气得分2）
      根气详情：卯本气根；亥中气根；卯本气根；被克：辛天干直克；酉(month)地支根被冲；酉(month)地支根被冲

四柱关系事件（事实层枚举）：
  - 天干克：year+month（火克金），涉月令/日支
  - 六冲：year+month（木、金），涉月令/日支
  - 天干克：year+day（金克木），涉月令/日支
  - 六冲：month+hour（金、木），涉月令/日支
  - 天干克：day+hour（木克土），涉月令/日支
  - 半合：year+day（卯亥合木），涉月令/日支

条件性结构风险（解释层；severity 仅存在/潜在；不是喜用忌结论，不得据此把风险元素解释成忌神）：
  - 杀重无制[存在]：年柱辛。七杀透干1处；证据 3 项（e1当令、e2本气强根、e3多现）。缓解：无。若七杀辛再得根增强而制化不足，杀重无制之势可能加重；出现印化杀或食伤制杀则风险可能解除。 结构显现：年柱辛七杀:exposedRooted
  - 关键用神/格局节点受冲[存在]：年柱卯 ↔ 月柱酉（格局核心杀之根）。六冲卯酉命中；月柱酉（格局核心杀之根），位距1、涉月令。缓解：无。若年柱卯（乙木·比肩）得运助增，对月柱酉（格局核心杀之根）的冲击可能加重，相关格局节点根基可能动摇。 结构显现：年柱year（乙木·比肩）:exposedRooted；月柱month（辛金·七杀）:exposedRooted
  - 关键用神/格局节点受冲[存在]：月柱酉（格局核心杀之根） ↔ 时柱卯。六冲酉卯命中月柱酉（格局核心杀之根），位距2、涉月令。缓解：无。若时柱卯（乙木·比肩）得运助增，对月柱酉（格局核心杀之根）的冲击可能加重，相关格局节点根基可能动摇。 结构显现：月柱month（辛金·七杀）:exposedRooted；时柱hour（乙木·比肩）:exposedRooted

四柱相邻生克关系：
  年柱 → 月柱：天干被克，地支冲
    - 月柱天干丁(火) 克 年柱天干辛(金)
    - 年柱地支卯 与 月柱地支酉 六冲——主变动冲突
  月柱 → 日柱：天干被生，地支生
    - 日柱天干乙(木) 生 月柱天干丁(火)
    - 月柱地支酉(金) 生 日柱地支亥(水)
  日柱 → 时柱：天干克，地支生
...
宫位远近分析：
  提纲(月柱)：月柱丁酉（提纲），食伤当令泄秀——才华外露，创意旺盛。
  归息(时柱)：时柱己卯（归息），晚岁财星——老来财运，但须身强。
  祖业(年柱)：年柱辛卯（祖业），祖上官杀——家规严苛或祖上有权威传承。
...
日支（夫妻宫）专项分析：
  ...
  日主根气：藏干中气根（根气分1）
  稳定度：稳固——配偶宫根基扎实，感情稳定
  三合角色：亥参与木局（卯卯），日支有合局之助
  三会角色：亥属水方，为三会局成员
  藏干详析：本气壬(正印)——本气正印——配偶包容温柔、照顾你 | 中气甲(劫财)——中气劫财——配偶行动力强但易争执
  综合：日支亥为正印，藏干中气根。稳固——配偶宫根基扎实，感情稳定。亥参与木局（卯卯），日支有合局之助

流年丙午三方互动分析：
  判词：偏凶（凶兆分3，吉兆分0）
  ⚠ [high] 伤官见官：流年伤官丙见原局/大运正官——今年谨防口舌官非、工作变动、与上级冲突
  总结：流年有挑战但非不可控。流年伤官丙见原局/大运正官——今年谨防口舌官非、工作变动、与上级冲突
...
大运喜用忌联动分析：
  ...
  丙申（8-1968岁）：天干火为忌神，地支金为忌神 → 综合判定：忌运
    运程：大运丙申（8-1968），天干火食伤（忌神），地支金（忌神）。此运忌神当道，宜守不宜攻。
  乙未（18-1978岁）：天干木为喜神，地支土为忌神 → 综合判定：偏喜 [大运未补全三合木局，所化五行在本命喜忌中为喜神；是否成化仍需结合月令、透干与受制情况判断。]
    运程：大运乙未（18-1978），天干木比劫（喜神），地支土（忌神）。天干有喜但地支为忌——表面风光，暗流涌动。
  甲午（28-1988岁）：天干木为喜神，地支火为忌神 → 综合判定：偏喜
    运程：大运甲午（28-1988），天干木比劫（喜神），地支火（忌神）。天干有喜但地支为忌——表面风光，暗流涌动。
  癸巳（38-1998岁）：天干水为用神，地支火为忌神 → 综合判定：偏喜 [大运冲日支（夫妻宫/自身根基）——十年动荡]
    运程：大运癸巳（38-1998），天干水印星（用神），地支火（忌神）。天干有喜但地支为忌——表面风光，暗流涌动。
  壬辰（48-2008岁）：天干水为用神，地支土为忌神 → 综合判定：偏喜
    运程：大运壬辰（48-2008），天干水印星（用神），地支土（忌神）。天干有喜但地支为忌——表面风光，暗流涌动。
  辛卯（58-2018岁）：天干金为忌神，地支木为喜神 → 综合判定：偏喜 [大运冲提纲（月支酉）——十年根基动摇]
    运程：大运辛卯（58-2018），天干金官杀（忌神），地支木（喜神）。天干为忌但地支有喜——内里有靠，低调蓄力。
  庚寅（68-2028岁）：天干金为忌神，地支木为喜神 → 综合判定：偏喜
    运程：大运庚寅（68-2028），天干金官杀（忌神），地支木（喜神）。天干为忌但地支有喜——内里有靠，低调蓄力。
  己丑（78-2038岁）：天干土为忌神，地支土为忌神 → 综合判定：忌运
    运程：大运己丑（78-2038），天干土财星（忌神），地支土（忌神）。此运忌神当道，宜守不宜攻。

神煞：太极贵人(ji-shen)、福星贵人(ji-shen)、禄神(ji-shen)、国印贵人(ji-shen)、将星(ji-shen)、灾煞(ji)、空亡(ji)、天德合(ji-shen)、月德合(ji-shen)、六厄(ji)、天哭(ji)

四柱地支冲合刑害：
  年柱卯 ←→ 月柱酉：六冲
    - 年柱地支卯 冲 月柱地支酉——变动冲突分离之象
  月柱酉 ←→ 时柱卯：六冲
    - 月柱地支酉 冲 时柱地支卯——变动冲突分离之象

当前时间：2026年
当前大运：庚寅（正官）2019-2028年 68岁
当前流年：丙午（伤官）2026年
  注意：当前行正官大运，遇伤官流年——需结合大运流年与原局关系综合判断吉凶。
...
```
【排盘事实锁】日主旺衰=「偏弱（37）」，候选格局=「食神制杀格」，状态=「破格」，原因=「月令受年柱冲；月令受时柱冲；食神虚透，制杀无力」。以上字段不另行重算；破格不得写成已成格；旺衰档位、格局状态、risk severity 均为冻结标签，禁止近义词换级。
```
