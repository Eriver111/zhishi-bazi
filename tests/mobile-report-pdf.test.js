...
test('service worker rolls the mobile PDF cache to v15 and precaches all local PDF scripts', () => {
  const source = read('sw.js');
  assert.equal((source.match(/var CACHE_NAME\s*=\s*'zhishi-v15'/g) || []).length, 1);
