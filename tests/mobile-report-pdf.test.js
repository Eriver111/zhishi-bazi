...
test('service worker rolls the mobile PDF cache to v19 and precaches all local PDF scripts', () => {
  const source = read('sw.js');
  assert.equal((source.match(/var CACHE_NAME\s*=\s*'zhishi-v19'/g) || []).length, 1);
