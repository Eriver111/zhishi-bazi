      ...
      try {
        ...
        chartContext = [
          ...
          '用神：' + dailyFacts.yongJi.yongShen.join('、') + '；喜神：' + dailyFacts.yongJi.xiShen.join('、')
            ...
            + (dailyFacts.yongJi.conditionalAuxiliaryElements && dailyFacts.yongJi.conditionalAuxiliaryElements.length ? '；条件辅助：' + dailyFacts.yongJi.conditionalAuxiliaryElements.join('、') + '（须配印，不可单用）' : '')
