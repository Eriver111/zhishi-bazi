...
function buildSingleChart(data) {
  ...
  if (data.parentAnalysis) {
    ...
    if (parents.judgements) ctx += `  家庭文案用日常说话的方式讲清：谁想怎么做，另一方怎么想，双方具体在哪件事的做法上意见不同。不要用“照顾到哪一步为止”“关系支点”“同等位置”“自主空间的拉扯”代替解释。例如应说“她想替你安排，你希望自己决定”，不能只说“需要协调边界”。例子不得冒充用户已经发生的经历。\n`;
