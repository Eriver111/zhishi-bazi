...
var hs=document.getElementById("zwH");for(var i=0;i<24;i++){var dzIdx=Math.floor(i/2)%12;var o=document.createElement("option");o.value=i;o.textContent=i+"点 ("+DZ_H[dzIdx]+"时)";if(i===2)o.selected=true;hs.appendChild(o);}
...
var lng=CITY_LNG[city]||PROV_LNG[prov]||116.4,om=Math.round((120-lng)*4);
var t=new Date(y,m-1,d),doy=Math.floor((t-new Date(y,0,0))/86400000);
var b2=360/365*(doy-81);
